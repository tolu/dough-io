...
/*jshint -W030, browser:true, devel:true */
(function (window, Firebase, $) {
    ...
    expenses.on('child_added', function (snap) {
        var data = snap.val();
        var key = snap.key();
        $('.expenses ul').append(expenseTpl.format(key, data.value, data.name));
    });
    ...
    members.on('child_added', function (snap) {
        ...
        $('.members ul').append(personTpl.format(key, value));
    });
    ...
    String.prototype.format = function(){
        ...
        var args = typeof arguments[0] !== "object" ?
